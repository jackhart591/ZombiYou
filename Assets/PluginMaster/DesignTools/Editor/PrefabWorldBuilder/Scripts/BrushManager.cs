...
namespace PluginMaster
{
    ...
    public static partial class PWBIO
    {
        ...
        private static void BrushDuringSceneGUI(UnityEditor.SceneView sceneView)
        {
            ...
            if (BrushRaycast(mouseRay, out RaycastHit hit, float.MaxValue, -1, BrushManager.settings, null))
        ...
        private static void DrawBrush(UnityEditor.SceneView sceneView, RaycastHit hit, bool preview)
        {
            ...
            if (preview) BrushstrokePreview(hit.point, hit.normal, tangent, bitangent, sceneView.camera);
        }
