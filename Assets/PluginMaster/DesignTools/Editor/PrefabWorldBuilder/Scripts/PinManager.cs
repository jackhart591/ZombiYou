...
namespace PluginMaster
{
    ...
    public static partial class PWBIO
    {
        ...
        private static void DrawPinHandles(Matrix4x4 rootToWorld)
        {
            ...
            UnityEditor.Handles.color = new Color(0f, 0f, 0f, 0.7f);
            UnityEditor.Handles.DotHandleCap(418, _pinHit.point, Quaternion.identity,
                UnityEditor.HandleUtility.GetHandleSize(_pinHit.point) * 0.0425f * PWBCore.staticData.controPointSize,
                EventType.Repaint);
            UnityEditor.Handles.color = UnityEditor.Handles.selectedColor;
            UnityEditor.Handles.DotHandleCap(418, _pinHit.point, Quaternion.identity,
                UnityEditor.HandleUtility.GetHandleSize(_pinHit.point) * 0.03f * PWBCore.staticData.controPointSize,
                EventType.Repaint);
        }
    }
    #endregion
